...
Kp3=10000 # Proportional constant for the 3rd tank
...
tank_12,=ax0.plot([],[],'royalblue',linewidth=217,zorder=0)
...
tank_22,=ax1.plot([],[],'royalblue',linewidth=218,zorder=0)
plt.xlim(-radius*width_ratio,radius*width_ratio)
plt.ylim(bottom,final_volume)
plt.xticks(np.arange(-radius,radius+1,radius))
plt.yticks(np.arange(bottom,final_volume+dVol,dVol))
...
tank_32,=ax2.plot([],[],'royalblue',linewidth=217,zorder=0)
plt.xlim(-radius*width_ratio,radius*width_ratio)
plt.ylim(bottom,final_volume)
plt.xticks(np.arange(-radius,radius+1,radius))
plt.yticks(np.arange(bottom,final_volume+dVol,dVol))
